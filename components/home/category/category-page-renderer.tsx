...
// renderer to show CLEAN categories at their canonical (already-clean) URL -
// without this, the redirect below would fire again and loop against itself.
export const renderCategoryPage = async (props: {
...
export async function generateCategoryPageMetadata(props: {params: CategoryPageParams; searchParams: CategoryPageSearchParams}) {
    const params = await props.params;
    const searchParams = await props.searchParams;
