...
export const ThreePLServicesDetails = () => {
    ...
    const ServiceCard = ({ title, icon, children, highlight = false }) => (
        <div className={`bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 ${highlight ? 'border-primary-200 bg-gradient-to-br from-primary-50 to-white' : 'border-gray-100'}`}>
            <div className="flex items-center gap-3 mb-4">
                <div className={`w-12 h-12 rounded-xl ${highlight ? 'bg-primary-500' : 'bg-gradient-to-r from-blue-500 to-purple-600'} text-white flex items-center justify-center text-xl font-bold`}>
                    {icon}
                </div>
    ...
    const PricingTier = ({ range, price, highlight = false }) => (
    ...
    const FreeServiceItem = ({ name, icon }) => (
        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
            <div className="w-8 h-8 bg-green-500 rounded-lg text-white flex items-center justify-center text-sm">
                {icon}
            </div>
          ...
          <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                From FBA prep to storage solutions, we handle your fulfillment so you can focus on growing your
                business.
              </p>
