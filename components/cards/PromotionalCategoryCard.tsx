...
const PromotionalCategoryCard: FC<CategoryCardProps> = ({category}) => {
  return (
    <Link
      ...
      className={`category-card h-full w-full text-start block relative bg-white border border-[#d9dee4] border-t-[3px] sm:border-t-body hover:border-t-[#e42b1e]`}
    >
      <div className="pt-14 pb-2 sm:py-10 flex flex-col sm:flex-row items-center px-6 2xl:px-0 gap-6 xl:gap-0">
        ...
        <div className="xl:pr-4">
          <Link
            href={category.uniqueCategoryName}
            className={`mb-4 block text-body hover:text-[#e42b1e] font-bold text-sm sm:text-base 2xl:text-[18px] text-center sm:text-left capitalize`}
          >
            <span
          ...
          <ul className="hidden text-mute3 sm:block text-[14px] font-semibold space-y-1 category-card__categories">
