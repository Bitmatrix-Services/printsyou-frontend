    ...
    <section className="bg-greyLight pt-2 pb-2 ">
      <div className="pt-2 pb-11 ">
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          the buyer confirms entrance into a contractual agreement with
          Identity-Links and approves Identity-Links' permission to first apply
          any outstanding balance to the payment method provided, until said
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          balances. The buyer agrees to pay all Identity-Links' attorney and
          collection agency fees incurred in the pursuit of any amount owed
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          contain terms that differ from those contained in the buyer's Purchase
          Order. To the extent that this is the case, Identity-Links expressly
          conditions its acceptance of the buyer's offer on Identity-Links'
          assent to the additional or differing terms. The buyer's receipt and
          retention of the goods shall constitute acceptance of any such
          additional or differing terms. The buyer and Identity-Links agree that
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          Identity-Links must be contacted immediately. Otherwise, said changes
          may not be able to be made before the order ships. If additional
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          agreed upon price for any work completed up to the time that the order
          is cancelled. Cancellations result in the buyer being assessed for any
          production charges accrued at the time. These charges may include, but
          are not limited to: setup charges, artwork preparation charges, paper
          or product proofs, shipping charges, digitizing or embroidery, and
          restocking fees. All completed work and costs incurred will be the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          the order number immediately or within 15 days of receipt at the very
          latest. After this time, Identity-Links will be unable to go back to
          suppliers for credit. If necessary, Identity-Links will issue an RMA
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          reviewed. Before Identity-Links can begin to process a claim, a
          sampling of the goods (quantity will be determined at Identity-Links'
          discretion) must be provided for review. Identity-Links reserves the
          right to take up to 7 working days to process a claim from the date of
          receipt of the goods in question. Any credits, returns, or refunds
          will be processed within 2 business days after review, unless
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          the same state as the buyer, the buyer will be subject to their local
          state tax rate. Buyers in other states may be required to remit use
          taxes. Buyers are encouraged to consult a tax advisor if more specific
          information is needed. Companies, individuals, and organizations
          exempt from sales tax must provide Identity-Links with a copy of the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          the carrier name and your account number via email. If you choose to
          use your own account, you will be solely responsible for the insuring
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          delays on the part of the carrier who is delivering said merchandise.
          In rare instances, Identity-Links may ship the item after the intended
          ship date using a faster shipping method in order to meet the intended
          receipt date. The additional cost for this will be at Identity-Links'
          expense. While an in-hands DATE is guaranteed, Identity-Links is
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          suppliers, and in no case shall Identity-Links be liable for any
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          specifically makes no implied warranties of merchantability or fitness
          for purpose.
        </p>
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          exact representation of how the final imprint will look when printed.
          Due to the different calibrations of monitors, the colors shown may
          vary from screen to screen. If a specific color is needed for your
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          rare instances when an error goes unnoticed. For this reason,
          Identity-Links highly recommends that the buyer carefully check all
          paperwork before signing off and submitting approval. Identity-Links
          cannot be held responsible for any incorrect interpretations of
          artwork or order approval. If additional information is required, the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          Furthermore, Identity-Links cannot be held responsible for any damages
          that may be incurred as a result of the error after the order has been
          printed and accepted by the buyer. Once the buyer approves the Digital
          Proof and Order Acknowledgement, Identity-Links is not at liberty to
          make ANY changes to the order. Whether correct or with errors, the
          order is printed exactly as approved by the buyer. Therefore, it is
          EXTREMELY IMPORTANT for the buyer to carefully look over ALL paperwork
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          their ability to convey an item’s color or quality, we implore
          customers to take advantage of our free sample policy to review the
          item in person prior to placing a bulk printed order. Identity Links
          can’t be held responsible if the customer forgoes the optional free
          sample and receives an item which does not meet their expectations in
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          accept merchandise with reasonable manufacturing variances in product
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          yellow product may appear with a green tint, a white imprint on a red
          product may appear with a pink tint, and so forth. Color
          ...
          advise the buyer of the best ink color for each product at the time of
          ordering.
        </p>
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          factors can impact the accuracy of the QR code, including the quality
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          it is always a good practice to provide an alternative method for
          accessing the information encoded in the QR code, such as a URL or a
          text-based code, to ensure that users can still access the information
          even if the QR code is not functioning correctly. In some instances, a
          printer may charge a fee to print QR codes and Identity Links will
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          conditions may change the price of a product. Identity-Links reserves
          the right to change prices and descriptions on the website at anytime.
          If a site price or description is incorrect on an item ordered,
          Identity-Links will contact the buyer prior to processing the order
          with the most updated price and information for approval.
        </p>
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          ability to communicate color, scale, and detail and Identity-Links
          ...
          physical sample, Identity-Links cannot be held responsible for
          discrepancies between the product description or site image as seen on
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          owners, authorized agents, or affiliates with proper permission from
          the copyright holders. Any buyer from Identity-Links represents and
          warrants to Identity-Links that he or she has the unrestricted right
          to use, copy, and distribute each copyright, trademark, service mark,
          trade name, logo, statement, graphic, artwork, name, photograph,
          portrait, picture, or illustration of any person or any other
          intellectual property in the way it is to be printed on or otherwise
          applied to the promotional merchandise ordered by the buyer. All
          buyers must agree to defend, indemnify, and hold Identity-Links
          harmless from any claims, suits, or actions alleging that the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          written permission from the owner of the logo, trademark, or copyright
          or be an employee, authorized agent, or affiliate of the owner. A
          buyer may NOT use any logo or other graphic material in a manner which
          may infringe copyright. A buyer may NOT use any logo or trademark in a
          vulgar, libelous, disparaging, or otherwise unlawful manner.
          Identity-Links assumes no responsibility for any damages or
          wrongdoings that the buyer may cause using a logo, trademark, or
          copyrighted item. Identity-Links shall not be held liable for the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          protected by the United States and International Copyright Laws.
          ...
          when a work is created. This protection is available to both published
          and unpublished works. Copyright protection subsists from the time the
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          cancel any such order for any reason at any time. Identity-Links
          enforces this policy to ensure a secure, professional, and convenient
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          Identity-Links' products and services; and to understand buyer and
        ...
        <p className="font-medium text-mute3  text-[16px] leading-[30px] font-poppins pb-6">
          ...
          they do allow Identity-Links to analyze guest use of the website. This
          analysis helps Identity-Links to better understand which areas of the
          website are most useful and popular so improvements and updates can be
          planned accordingly. Identity Links does not use cookies to retrieve
          information from a visitor's computer that was not originally sent in
          a cookie. In addition, Identity-Links may also use standard software
          to collect non-identifying information about visitors to the website
          such as: date and time of site access, IP Address (a numeric address
          given to servers connected to the internet), and web browser used.
        </p>
      </div>
    </section>
  );
