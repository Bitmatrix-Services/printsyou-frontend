...
export const sectionDetials = [
  ...
  },
  {
    title: 'Email',
    description:
      "If you just don/'t have the time to fill out the online form or call us, you can shoot us a quick email to info@printsyou.com. Please include as much information as possible about the product you are interested in, such as item number, size, color, quantity and the shipping address. One of our dedicated sales associates will return your email during regular business hours. Any questions that you have regarding your order can be sent via email as well.",
