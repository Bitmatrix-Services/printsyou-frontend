  ...
  return (
    ...
    >
      <div className="pt-14 pb-2 sm:py-10 flex flex-col 2xl:flex-row items-center px-6 2xl:px-0 gap-6 xl:gap-0">
        <figure className="block absolute -top-16 left-1/2 -translate-x-1/2 sm:top-0 sm:left-0 sm:translate-x-0 sm:relative min-w-[7rem] w-28 h-28 sm:min-w-[13.125rem] sm:w-[13.125rem] sm:h-[13.125rem] 2xl:min-w-[8.5rem] 2xl:w-[8.5rem] 2xl:h-[8.5rem] 2xl:scale-105 2xl:-translate-x-11">
          <ImageWithFallback
