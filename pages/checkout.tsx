  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`${config.publicRuntimeConfig.FE_URL}checkout`}
      />
      <div>
                  ...
                  <div className="px-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs my-4">
                        *Final total including shipping and any additional
                        charges will be sent with the artwork proof after the
                        order is placed.
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        <div className="flex space-x-4 mt-6">
                          ...
                          <label className="ml-2" htmlFor="newsLetter">
                            Be up to date with our promotions, sign up for our
                            email newsletters now.
                          </label>
                        </div>
                        <div className="flex space-x-4 mt-6">
                          <input
          ...
          <div className="px-8 lg:px-16 pt-8">
            <div className="flex flex-col mt-6 mb-16">
              ...
              <div className="pt-4 space-y-4">
                <p>
                  If you have placed your order during our regular business
                  hours, Monday through Friday from 8 AM to 5 PM CST, you can
                  expect to receive a response from one of our dedicated sales
                  associates within one hour. Orders placed outside of our
                  regular business hours will be processed on the next business
                  day.
                </p>

                <p>
                  All orders require artwork to be processed. If you did not
                  attach the artwork with your order request, you can simply
                  ...
                  create a digital proof so that you can see how your
                  logo/message will look on the product. This will be sent along
                  with a sales confirmation of your order.
                </p>
                ...
                <p>
                  Please do not hesitate to contact us with any questions that
                  you have during the order process by emailing us at
                  info@printsyou.com
                </p>
              </div>
